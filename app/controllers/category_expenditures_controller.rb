  ...
  def create
    ...
    respond_to do |format|
      if @category_expenditure.save
        format.html { redirect_to category_expenditure_url(@category_expenditure), notice: "Category expenditure was successfully created." }
  ...
  def update
    respond_to do |format|
      if @category_expenditure.update(category_expenditure_params)
        format.html { redirect_to category_expenditure_url(@category_expenditure), notice: "Category expenditure was successfully updated." }
